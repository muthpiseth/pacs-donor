...
import  img  from '../../assets/images/eCommerce-Icon-1.png';
            ...
            items={[
              {
                key: "donor",
                icon: <DonorSetting />,
                label: <div className="h5-bold-size13">Ecommerce</div>,
                children: [
                  {
                    key: "/",
                    icon: <UnorderedListOutlined />,
                    label: collapsed ? "Dashboard" : <div className="h5-bold-size13">Dashboard</div>,
                  },
                  {
                    key: "/group",
